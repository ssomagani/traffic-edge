...
import com.voltdb.Application;
import com.voltdb.Road;
import com.voltdb.Road.Command;
...
public class SimpleConsumer extends AbstractSimpleKafka {
     ...
     * the class {@link com.voltdb.kafka.demo.kafka.PropertiesHelper} object
     *
     * @param topicName    the topic to access
     * @param callback the callback function that processes messages retrieved
     *                 from Kafka
...
//    	sp.runAlways("traffic", new TrafficMessageHandlerImpl());
//    }
